...
/*
 * AI使用について
 * OpenAI Codexを、Reactコンポーネントへの分割、作品データ構造の整理、
 * PC・スマートフォン向けCSS、マウス追従・カルーセル・フィルター・
 * 作品詳細モーダルの実装、文章の整理と推敲、ビルド・Lint・表示確認に使用した。
 * サイトのコンセプト、掲載する事実、文章の最終表現、デザイン上の判断は
 * 制作者本人が行い、AIの提案と生成コードを確認・修正した上で採用した。
 */
